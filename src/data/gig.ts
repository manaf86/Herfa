...
export const quickBadges = [
  { key: "delivery", label: "التسليم خلال ٥ أيام" },
  { key: "revisions", label: "٤ تعديلات" },
...
export const aboutParagraphs = [
  ...
  "لدي أكثر من ٧ سنوات من الخبرة في تصميم الهويات لأكثر من ٣٠٠ علامة تجارية في السعودية والخليج، من متاجر صغيرة إلى شركات ناشئة مموّلة. كل هوية تخرج من عندي جاهزة للنشر، بملفات مصدرية مفتوحة وأدلّة استخدام واضحة.",
];
...
export const trustSignals = {
  onTimeDelivery: "٩٨٪ تسليم بالموعد",
  responseTime: "الرد أقل من ساعة",
  herfaIndex: "مؤشر حِرفة ٩٤",
};
